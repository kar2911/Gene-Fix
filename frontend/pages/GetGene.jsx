...
function GetGene() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true)
    try {
      const res = await axios.post("http://localhost:8000/gene-fix", form)
  ...
  return (
    <div className="max-w-xl mx-auto p-6">
      <h2 className="text-2xl font-semibold mb-4">
        🧬 GeneFixer - Enter Mutation Details
      </h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {renderSelect("Mutation (HGVS format)", "mutation", [
          "p.R175H",
          "p.G12D",
          "p.G12C",
          "p.G13D",
        ...
        {renderSelect("Mutation Type", "mutation_type", [
          "Missense",
          "Nonsense",
          "Insertion",
          "Deletion",
        ])}
        {renderSelect("Disease Association", "disease_association", [
        ...
        {renderSelect("Mutation Impact", "mutation_impact", [
          "Deleterious",
          "Neutral",
        ])}
        {renderSelect("Mutation Frequency", "mutation_frequency", [
          "High",
          "Medium",
          "Low",
        ])}
        {renderSelect("Gene Function", "gene_function", [
          "Tumor Suppressor",
          "Oncogene",
          "DNA Repair Gene",
        ])}
        {renderSelect("Family History", "family_history", [
          "Yes",
          "No",
          "Unknown",
        ])}
        ...
        {renderSelect("gRNA Sequence", "grna", [
          "GAGGAGGGGGAGGAG",
          "GAGGAGGGAGAGGAGG",
          "TGGAGAGGGAGGAGG",
          "GAGGGAGGAGGGAG",
